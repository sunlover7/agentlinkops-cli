...
const GEMINI_RAW_SOURCES_DOM_EXTRACTOR = String.raw`(_helpers) => {
	const results = [];
...
async function extractSourcesFromGemini(page, sourcesButton) {
...
export {
  GEMINI_RAW_SOURCES_DOM_EXTRACTOR,
  extractSourcesFromGemini
};
