...
const CHATGPT_RAW_SOURCES_DOM_EXTRACTOR = String.raw`(_helpers) => {
	const results = [];
...
async function extractSourcesFromChatgpt(page, sourcesButton) {
...
export {
  CHATGPT_RAW_SOURCES_DOM_EXTRACTOR,
  extractSourcesFromChatgpt
};
